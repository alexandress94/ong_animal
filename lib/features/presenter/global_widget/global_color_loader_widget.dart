...
class GlobalColorLoadedWidget extends StatefulWidget {
  final double radius;
  final double dotRadius;

  const GlobalColorLoadedWidget(
      {Key? key, this.radius = 30.0, this.dotRadius = 3.0})
      : super(key: key);

  @override
  _GlobalColorLoadedWidgetState createState() =>
      _GlobalColorLoadedWidgetState();
}

class _GlobalColorLoadedWidgetState extends State<GlobalColorLoadedWidget>
